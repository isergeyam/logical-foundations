...
Proof.
  ...
  - simpl. destruct re1;
    try (destruct re2; try (apply MApp; try apply IH1; apply IH2); 
    inversion IH2; rewrite app_nil_r; apply IH1).
    inversion IH1. simpl. destruct re2; apply IH2. 
  - simpl. destruct re1; 
    try (destruct re2; try (apply MUnionL; apply IH); apply IH). 
    inversion IH. 
  - simpl. destruct re1; try apply IH; destruct re2; 
    try (apply MUnionR; apply IH); inversion IH. 
  - simpl. destruct re; constructor. 
 - simpl. destruct re; 
   try (apply star_app; try apply IH2; apply MStar1; apply IH1). 
   inversion IH1. 
   inversion IH1. inversion IH2. apply MEmpty. 
Qed. 

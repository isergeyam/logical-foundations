...
Proof.
  ...
  - destruct IHHce1 as [i1 IHHce1]. 
    ...
    exists (i1 + i2). destruct i1. simpl in IHHce1. discriminate. 
    destruct i2. simpl in IHHce2. discriminate. 
    simpl. 
    assert (H1: S i1 <= i1 + S i2). {lia. } 
    assert (H2: S i2 <= i1 + S i2). {lia. } 
    apply (ceval_step_more (S i1) (i1 + S i2) st st' c1 H1) in IHHce1. 
    rewrite IHHce1. 
    apply (ceval_step_more (S i2) (i1 + S i2) st' st'' c2 H2) in IHHce2. 
    assumption. 
  ...
  - destruct IHHce1 as [i1 IHHce1]. 
    destruct IHHce2 as [i2 IHHce2]. 
    exists (i1 + i2). destruct i1. simpl in IHHce1. discriminate. 
    destruct i2. simpl in IHHce2. discriminate. simpl. rewrite H. 
    eapply ceval_step_more in IHHce1. 
    rewrite IHHce1. 
    eapply ceval_step_more in IHHce2. 
    apply IHHce2. 
    lia. lia. 
Qed. 
(** [] *)

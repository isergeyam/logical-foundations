...
Proof.
  ...
  - induction m as [|m IHm]. 
    ...
    + intros H. 
      ...
      discriminate H. 
  - intros m. induction m as [|m' IHm']. 
    + intros H. rewrite <- plus_n_Sm in H. discriminate H. 
    + intros H. 
      rewrite <- plus_n_Sm in H.
      rewrite <- plus_n_Sm in H. 
      rewrite plus_comm in H. 
      rewrite <- plus_n_Sm in H. 
      assert (H1: S m' + m' = S(m' + m')).
      {rewrite plus_comm. rewrite plus_n_Sm. reflexivity. }  
      rewrite H1 in H. 
      injection H as H2. 
      apply IHn in H2. 
      f_equal. 
...
Theorem combine_split : forall X Y (l : list (X * Y)) l1 l2,
  ...
  combine l1 l2 = l. 
Proof.
  induction l as [ | [x y] l IH]; intros l1 l2 H. 
- inversion H. reflexivity. 
- simpl in H. destruct (split l) as [l1' l2']. 
  inversion H.  subst. simpl. rewrite IH; reflexivity. 
Qed.
(** [] *)
...
Proof.
  intros f b. 
  destruct b as []. 
  - destruct (f true) as [] eqn:E. 
    + rewrite E. 
      apply E. 
    + destruct (f false) as [] eqn:E1. 
      * apply E. 
      * apply E1. 
  - destruct (f false) as [] eqn:E. 
...
Lemma list_length0 : forall (X : Type) (l : list X),
  length l = 0 -> l = [].
Proof.
  intros X l H. 
  destruct l as[|x l].
...
Proof.
  ...
  - intros l2 H. 
    simpl in H. 
    assert (H1: l2 = []). 
    {apply list_length0. symmetry. apply H. } 
    rewrite H1. 
    reflexivity. 
  - intros l2 H. 
    simpl. 
    ...
    + simpl in H. 
      injection H as H. 
      assert (H1: split (combine l1 l2) = (l1, l2)). 
      {apply IH. apply H. } 
      simpl. 
      rewrite H1. 
      reflexivity.

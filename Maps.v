...
Proof.
  ...
  unfold t_update. apply eqb_string_false_iff in H. rewrite H. reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  destruct (eqb_string x x0) as []. reflexivity. reflexivity. 
Qed.
(** [] *)
...
Proof.
  intros. apply iff_reflect. apply iff_sym. apply eqb_string_true_iff. 
Qed.
(** [] *)
...
Proof.
  ...
  destruct (eqb_stringP x x0). rewrite e. reflexivity. reflexivity. 
Qed.
(** [] *)
...
Proof.
  intros. unfold t_update. apply functional_extensionality. intros. 
  destruct (eqb_stringP x1 x). rewrite <- e. 
  destruct (eqb_stringP x2 x1). apply H in e0. destruct e0. reflexivity. 
